...
interface Sister2WelcomePopupProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function Sister2WelcomePopup({ isOpen, onClose }: Sister2WelcomePopupProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="relative w-[90vw] max-w-sm bg-gradient-to-br from-slate-900 via-purple-900 to-pink-900 rounded-2xl shadow-2xl border border-white/20">
        ...
        <div className="p-6 text-center">
          ...
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-300">
              Only <span className="font-bold text-amber-400">{spotsLeft}</span> spots left today
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-amber-500 to-orange-500 rounded-xl p-4 text-white mb-4">
            ...
            <p className="text-sm opacity-90">From ₹998 to just ₹389</p>
          </div>
