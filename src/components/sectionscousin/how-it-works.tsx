 ...
 * - Mobile: elegant vertical timeline with connectors
 * - Desktop: 3 step cards with animated gradient borders
 * - Subtle glassy background, radial accents, and hover polish
 * - Accessible: headings, aria labels, ordered semantics
 */
...
const STEPS = [
  {
    ...
    description:
      "Provide your name and birth date. This allows our gifted psychics to connect with your unique spiritual energy.",
  },
  {
    icon: <PsychicIcon className="h-9 w-9 text-primary md:h-12 md:w-12" />,
    title: "Our Artists Begin",
    description:
      "Our intuitive artists and astrologers use your energy to hand-draw a detailed sketch of your soulmate.",
  },
  {
    icon: <DeliveryIcon className="h-9 w-9 text-primary md:h-12 md:w-12" />,
    title: "Receive Your Sketch",
    description:
      "Your sketch and love reading are delivered privately via email or WhatsApp within 24–48 hours.",
  },
];
    ...
    >
      ...
      <div className="container mx-auto px-4">
        ...
        <p className="mt-3 text-center text-sm text-foreground/60">
          Private, secure, and tailored to you — start in minutes.
        </p>
      </div>
    </section>
  );
