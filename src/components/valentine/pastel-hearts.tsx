...
// Pastel colors — visible on light nude/pastel backgrounds
const PASTEL_COLORS = [
  ...
  "rgba(253, 242, 248, 0.9)",    // pink-100 (softer)
  "rgba(244, 114, 182, 0.6)",    // pink-400 lighter
  "rgba(251, 113, 133, 0.6)",    // rose-400 lighter
          ...
          >
            <svg
              ...
              style={{
                ...
                filter: "drop-shadow(0 1px 2px rgba(0,0,0,0.08)) drop-shadow(0 0 8px rgba(251,113,133,0.25))",
              }}
            >
              <path d={HEART_PATH} />
            </svg>
