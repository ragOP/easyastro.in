            ...
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center mb-12">
                    ...
                    <p className="text-gray-600 text-lg">
                        An exclusive bundle of mystical insight and energized crystals
                    </p>
                </div>

                <div className="block md:hidden space-y-8 max-w-5xl mx-auto">
                    <div className="relative bg-white rounded-2xl shadow-xl p-6 border border-purple-100 hover:shadow-2xl transition-shadow duration-300">
                        ...
                        <div className="flex flex-col">
                            <h3 className="text-2xl font-playfair text-purple-800 mb-6">
                                {Bundle.digital.title}
                            </h3>
                            ...
                            <img
                                src="/feature-1.jpeg"
                                alt="Example of hand-drawn psychic soulmate sketch showing detailed facial features and characteristics"
                                className="w-full mt-4 h-auto rounded-lg shadow-lg object-contain"
                                loading="lazy"
                            />
                        </div>
                    </div>
                    ...
                    <div className="relative bg-white rounded-2xl shadow-xl p-6 border border-purple-100 hover:shadow-2xl transition-shadow duration-300">
                        ...
                        <div className="flex flex-col">
                            ...
                            <img
                                src="/feature-2.jpeg"
                                alt="Love & Money Attractor Bracelet Benefits - Balance Between Love & Ambition, Boosts Confidence in Love & Career, Attract Abundance & Loving Relationships, Heart-led Decision Making"
                                className="w-full mt-4 h-auto rounded-lg shadow-lg object-contain"
                                loading="lazy"
                            />
                        </div>
                ...
                <div className="hidden md:grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                    <div className="space-y-6">
                        <div className="relative bg-white rounded-2xl shadow-xl p-8 border border-purple-100 hover:shadow-2xl transition-shadow duration-300 h-96">
                            <div className="absolute -top-4 right-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white px-4 py-1 rounded-full text-sm">
                                Digital Delivery
                            </div>
                ...
                <div className="mt-8 text-center">
                    <CtaButton
                        isCartPage={false}
                        title="Yes! I Want My Sketch + Bracelet (₹799)"
                        className="px-6"
                    />
                    <p className="mt-4 text-sm text-gray-600">
                        🔒 Secure Payment • Fast Delivery • 100% Private
                    </p>
                </div>
            </div>
        </section>
