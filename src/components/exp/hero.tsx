              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-4 h-64 sm:h-80 md:h-96 lg:h-[500px]">
                ...
                <div className="relative group">
                  ...
                  <Image
                    ...
                    width={300}
                    height={500}
                    className="rounded-xl sm:rounded-2xl shadow-2xl w-full h-full object-cover filter blur-[2px] group-hover:blur-[1px] transition-all duration-300"
                    priority
                  />
                ...
                <div className="relative group">
                  <div className="absolute inset-0 rounded-xl sm:rounded-2xl blur-lg"></div>
                  <Image
                    src="/bracelet.jpg"
                    alt="Energized Love & Money Bracelet"
                    width={300}
                    height={500}
                    className="rounded-xl sm:rounded-2xl shadow-2xl w-full h-full object-cover"
                    priority
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent rounded-xl sm:rounded-2xl"></div>
                  <div className="absolute bottom-2 sm:bottom-4 left-2 sm:left-4 right-2 sm:right-4 text-white text-xs sm:text-sm font-poppins-semibold">
